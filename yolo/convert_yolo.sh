...
# Yolo
python export_yolo.py --weights ../../data/yolo/models/yolov7.pt --grid --end2end --dynamic-batch --simplify --topk-all 100 --iou-thres 0.65 --conf-thres 0.35 --img-size 640 640
